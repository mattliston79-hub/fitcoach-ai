 ...
 * Uses Haiku to classify the message into one of six signal categories.
 * Fails open — if the check errors for any reason, returns {safe: true}
...
Your only job is to detect whether a user message contains a safeguarding signal requiring an immediate safety response.
Return ONLY valid JSON. No other text.
{"signal":"NONE"|"MENTAL_HEALTH_LOW"|"MENTAL_HEALTH_SIGNIFICANT"|"MENTAL_HEALTH_CRISIS"|"PHYSICAL_CARDIAC"|"PHYSICAL_INJURY","confidence":0.0,"trigger_phrase":"exact words that triggered this or null"}
...
MENTAL_HEALTH_CRISIS: self-harm (current or recent), suicidal ideation, not wanting to be here, intent to harm self. When in doubt between SIGNIFICANT and CRISIS, always choose CRISIS.
PHYSICAL_CARDIAC: chest pain or tightness, arm or jaw pain during exercise, sudden breathlessness at rest, palpitations.
PHYSICAL_INJURY: sharp or sudden pain, new or worsening joint pain, pain that stops movement.
